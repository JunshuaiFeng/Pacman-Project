...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        # four corners order: (1,1), (1,top), (right, 1), (right, top)
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                nextStateCorners = ((nextx, nexty) == x for x in self.corners)
                hitsCorners = tuple([a or b for a, b in zip(state[1], nextStateCorners)])
                successors.append((((nextx, nexty), hitsCorners), action, 1))
